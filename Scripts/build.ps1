...
dotnet build ../lib/BlazorCacheBuster/BlazorCacheBuster.csproj -c Release /p:VersionSuffix="$VersionSuffix"
Confirm-PreviousCommand

Write-Message "Creating nuget package ..."
dotnet pack ../lib/BlazorCacheBuster/BlazorCacheBuster.csproj -c Release /p:VersionSuffix="$VersionSuffix" -o ../artifacts/nuget
Confirm-PreviousCommand
